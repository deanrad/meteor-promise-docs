...
The following shows two input fields whose values are reactively
fed into a server-side method via `Meteor.call`, and whose value
is reactively displayed in the textarea below:
...
```
# Demo 2 - with chaining, no latency
